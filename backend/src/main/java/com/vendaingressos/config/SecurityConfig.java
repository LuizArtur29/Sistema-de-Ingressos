    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/eventos/meus").hasAnyRole("USER", "ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/sessoes-evento/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/sessoes-evento/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/sessoes-evento/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/sessoes-evento/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/tipos-ingresso/sessao/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/api/tipos-ingresso/**").hasRole("ADMIN")
                        .requestMatchers("/api/administradores/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/ingressos/sessoes/**").hasAnyRole("USER", "ADMIN")
